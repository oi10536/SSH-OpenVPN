...
echo -e "|${color3} 08${color4}|	: Banned User SSH"
echo -e "|${color3} 09${color4}|	: Undo Banned User SSH"
echo -e "|${color3} 10${color4}|: เปลี่ยนรหัสหรือจำนวนวัน"
echo -e "|${color3} 11${color4}|: เพิ่มผู้ใช้งานแบบได้ไฟล์ที่ใส่ชื่อกับรหัสเรียบร้อย"
echo -e "|${color3} 12${color4}|: ตั้งค่า รีโมท (remote) และ เพลโหลด (host)"
echo -e "|${color3} 13${color4}|: reset รีโมท และ host เป็นค่าเริ่มต้น"
