...
wget -O /etc/squid3/squid.conf "https://adlottomm.000webhostapp.com/pritunl/squid.conf" 
...
wget -O /etc/nginx/nginx.conf "https://adlottomm.000webhostapp.com/pritunl/nginx.conf"
mkdir -p /home/vps/public_html
echo "!--"
echo "<?php phpinfo(); ?>" > /home/vps/public_html/info.php
wget -O /etc/nginx/conf.d/vps.conf "https://adlottomm.000webhostapp.com/pritunl/vps.conf"
...
echo -e "\033[01;31mInstall on 'Debian 8' Only \033[0m"
echo "-Pritunl"
echo "-MongoDB"
echo "-Vnstat"
echo "-Web Server"
echo "-Squid Proxy Port 80,8080"
echo "BY MMT-VPN'NAZE MASTER"
echo "TimeZone   :  Bangkok"
echo "Vnstat     :  http://$MYIP:81/vnstat"
echo "Nginx      :  http://$MYIP:81"
echo "Pritunl    :  https://$MYIP"
echo "SUPPORT
Facebook: www.facebook.com/ADMINMAZE
Line: popeye13501
Garena: popeye13501
Web: myloxx.xyz
Youtube: https://goo.gl/S4kvn9
"
echo "กรุณาคัดลอกโค้ดนี้ไปเพื่อติดตั้ง"
pritunl setup-key