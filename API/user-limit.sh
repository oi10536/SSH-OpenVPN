...
;;
*)
  echo " ใช้คำสั่ง พิมพ์ชื่อ=$1 1 เพื่อ จำกัด การล็อกอิน 1 ครั้งเท่านั้น"
  echo " ใช้คำสั่ง พิมพ์ชื่อ=$2 2 เพื่อสร้างการเข้าสู่ระบบสูงสุด 2 ครั้ง"   
rm -f /tmp/pid
rm -f /tmp/pid2
rm -f /tmp/pids
rm -f /tmp/sks
